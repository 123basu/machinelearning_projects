...
file_path = r'C:\Users\Basavaraj M\Documents\6 sem mini project_new (2)\6 sem mini project_new\6 sem mini project\new project'
with open(file_path, 'r', encoding='utf-8') as file:
    data = json.load(file)

# Create a map for numbers to symbols
number_to_symbols = {int(k): v for k, v in data.items()}
