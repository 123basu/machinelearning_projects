...
encrypted_a, encrypted_b, encrypted_c, encrypted_d = map(float, encrypted_data_parts)

# Reverse the mathematical operations to get the original parts
n = 1000  # Match the modulus used in encryption

decrypted_a = int(((encrypted_a * 10000) - n**4) / private_key**4)
decrypted_b = int(((encrypted_b * 10000) - n**3) / private_key**3)
decrypted_c = int(((encrypted_c * 10000) - n**2) / private_key**2)
decrypted_d = int(((encrypted_d * 10000) - n))
